...
export default function ShareDialogBox() {
    ...
    return (
        <Fragment>
            ...
            {/* Dialog  */}
            <Dialog className=" relative right-[1em] w-[25em]  md:right-0 md:w-0 lg:right-0 lg:w-0" open={open} handler={handleOpen} style={{ background: mode === 'light' ? 'rgb(74 65 155)' : '#2f3542', color: mode === 'dark' ? 'white' : 'black' }}>
                {/* DialogBody  */}
                <DialogBody >
                    ...
                    <div className=" text-center">
                        <h1 className=" text-gray-600">Powered By UXKD</h1>
                    </div>
                </DialogBody>
            </Dialog>
        </Fragment>
