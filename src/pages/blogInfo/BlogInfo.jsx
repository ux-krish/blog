...
function BlogInfo() {
  ...
  return (
    <Layout>
      <section className="rounded-lg h-full overflow-hidden max-w-4xl mx-auto px-4 mt-20">
        <div className=" py-4 lg:py-8">
          {loading ?
            ...
            <div>
              {/* Thumbnail  */}
              <img alt="content" className="mb-3 rounded-lg h-full w-full max-w-[500px] mx-auto"
